...
from qgis.PyQt.QtWidgets import QAction, QDialog, QVBoxLayout, QProgressBar
import time
...
class MyThread(QThread):
    ...
    def run(self):
        # Here in this run() function that the heavy work
        # must be done to show the progress bar
